...
options.version(pkg.version).option('-g, --ignore <subrepos>', descriptions.ignore, getList, []).option('-G, --ignore-file <file>', descriptions.ignoreFile, '.updataignore').option('-l, --list <subrepos>', descriptions.list, getList, []).option('-L, --list-file <file>', descriptions.listFile, '.hgsub').option('-p, --pull-only', descriptions.pullOnly).option('-q, --quiet', descriptions.quiet).option('-t, --tag <id>', descriptions.tag, 'tip').option('-v, --verbose', descriptions.verbose).parse(process.argv);
